...
export const EXAMPLE_CURVES = [
  {
    ...
    isExample: true,
    name: 'Micro Pause',
    desc: 'Delaying the hands-away which forces a rushed slide to maintain the rate',
  ...
  },
  {
    ...
    isExample: true,
    name: 'Slow Catch',
    desc: 'Hanging at the catch or missing water',
  ...
  },
  {
    ...
    isExample: true,
    name: 'No Ratio',
    desc: 'Drive time is same as recovery',
